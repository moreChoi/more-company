        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <a 
              ...
              className="group flex items-center justify-center gap-2 bg-white text-blue-700 hover:bg-gray-50 px-8 py-5 rounded-full font-bold text-lg transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 w-full sm:w-auto"
            >
